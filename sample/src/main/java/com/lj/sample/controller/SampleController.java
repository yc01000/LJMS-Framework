package com.lj.sample.controller;
...
import com.lj.core.util.IBSBookings;
import com.lj.core.util.WebUtils;
import com.lj.sample.service.SampleService;
...
public class SampleController {
    ...
    public String isDomestic(@PathVariable String airportCode) {
        return "" + IBSBookings.isDomestic(airportCode);
    }
}
