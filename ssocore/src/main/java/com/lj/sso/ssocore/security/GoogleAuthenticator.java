 ...
 * <pre>
 * <B>lj.pss.support</B>
 *     |_ GoogleAuthenticator.java
 * </pre>
 * 
 *  @author  : WCJUNG
 *  @date    : 2018. 11. 19. 오후 4:49:51 
 *  @version : 1.0
...
public class GoogleAuthenticator {
	...
	public static String generateSecretKey() {
		...
		byte[] secretKey = new byte[secretSize];
		System.arraycopy(buffer, 0, secretKey, 0, secretSize);// Arrays.copyOf(buffer, secretSize);
	...
	public static String getQRBarcodeURL(String secret) {
		String format = "http://chart.apis.google.com/chart?cht=qr&chs=300x300&chld=L&choe=UTF-8&chl=" + secret;
		// String format =
		// "https://www.google.com/chart?chs=150x150&chld=M%%7C0&cht=qr&chl="+secret;
		return format;
	}
	...
	public long generate_code(String secret, long timeMsec) {
		Base32 codec = new Base32();
		byte[] decodedKey = codec.decode(secret);
