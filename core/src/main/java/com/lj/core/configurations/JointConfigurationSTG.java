...
@Configuration
@MatcherProfile("stg")
public class JointConfigurationSTG {
	/**
	...
	public PropertiesFactoryBean integrationConfig() {
		...
		bean.setLocations(new ClassPathResource("property/stg/integration-properties.xml"));
		return bean;
	}
	...
	public PropertiesFactoryBean fileExtensionConfig() {
		PropertiesFactoryBean	bean	= new PropertiesFactoryBean();
		bean.setLocations(new ClassPathResource("property/stg/file-properties.xml"));
		return bean;
	}
}
