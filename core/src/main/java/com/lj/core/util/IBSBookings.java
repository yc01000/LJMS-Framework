...
import com.lj.core.integration.soap.ibs.domain.booking.AcceptWlRS;
...
import com.lj.core.integration.soap.ibs.domain.booking.AmountInfoType;
import com.lj.core.integration.soap.ibs.domain.booking.BookingChannelKeyType;
...
import com.lj.core.integration.soap.ibs.domain.booking.ConfirmBookingSegmentRS;
import com.lj.core.integration.soap.ibs.domain.booking.ConfirmPriceRS;
import com.lj.core.integration.soap.ibs.domain.booking.ContactDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.CreateBookingRS;
import com.lj.core.integration.soap.ibs.domain.booking.DateOnlyDetailsType;
...
import com.lj.core.integration.soap.ibs.domain.booking.FareDetailsForGuestType;
import com.lj.core.integration.soap.ibs.domain.booking.FlightIdentifierInfoType;
import com.lj.core.integration.soap.ibs.domain.booking.FlightSegmentDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.FlightSegmentSummaryDetails;
import com.lj.core.integration.soap.ibs.domain.booking.GuestPriceBreakDownType;
import com.lj.core.integration.soap.ibs.domain.booking.GuestReponseDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.GuestRequestDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.GuestTicketDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.ItinPriceType;
import com.lj.core.integration.soap.ibs.domain.booking.ItineraryDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.ModifyBookingRS;
import com.lj.core.integration.soap.ibs.domain.booking.PaxCountDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.PaxCountType;
import com.lj.core.integration.soap.ibs.domain.booking.PaxDetailsType;
import com.lj.core.integration.soap.ibs.domain.booking.PaxPricingInfoType;
import com.lj.core.integration.soap.ibs.domain.booking.PnrContactType;
import com.lj.core.integration.soap.ibs.domain.booking.PnrSummary;
import com.lj.core.integration.soap.ibs.domain.booking.PricingComponentInfoType;
import com.lj.core.integration.soap.ibs.domain.booking.PricingInfoType;
import com.lj.core.integration.soap.ibs.domain.booking.RejectScRS;
import com.lj.core.integration.soap.ibs.domain.booking.ReservationStatusDetailsType;
...
import com.lj.core.integration.soap.ibs.domain.booking.SaveModifyBookingRS;
import com.lj.core.integration.soap.ibs.domain.booking.SegmentAvailabilityType;
import com.lj.core.integration.soap.ibs.domain.booking.SegmentInfoType;
...
public class IBSBookings {
	...
	private static final String IBS_BOOKING_CHANNEL_CHANNEL_TYPE = "API";

	private static final String IBS_BOOKING_CHANNEL_LOCALE = "en_US";
...
//		}
	...
	public static BookingChannelKeyType bookingChannelKey(String channel) {
		...
		channelKey.setChannelType(IBS_BOOKING_CHANNEL_CHANNEL_TYPE);
		channelKey.setChannel(channel);
		channelKey.setLocale(IBS_BOOKING_CHANNEL_LOCALE);
		return channelKey;
	}

	public static BookingChannelType bookingChannel(String channel) {
		BookingChannelType channelType = new BookingChannelType();
		channelType.setChannelType(IBS_BOOKING_CHANNEL_CHANNEL_TYPE);
		channelType.setChannel(channel);
		channelType.setLocale(IBS_BOOKING_CHANNEL_LOCALE);
		return channelType;
	}
	...
	private static ErrorType error(Object object) {
		if(object == null) {
			...
			error.setErrorCode("SERVER_ERROR_OCCURRED");
			return error;
		}
	...
	public void setCityAirportHandler(CityAirportHandler cityAirportHandler) {
		IBSBookings.cityAirportHandler = cityAirportHandler;
	}

	@Autowired
	public void setCountryHandler(CountryHandler countryHandler) {
		IBSBookings.countryHandler = countryHandler;
	}
