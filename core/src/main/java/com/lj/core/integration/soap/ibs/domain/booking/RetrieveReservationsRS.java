 ...
 *       &lt;sequence>
 *         &lt;element name="PNR" type="{http://www.ibsplc.com/iRes/simpleTypes/}PNR" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "RetrieveReservationsRS")
public class RetrieveReservationsRS {

    @XmlElement(name = "PNR")
    protected List<PNR> pnr;
