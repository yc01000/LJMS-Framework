...
/**
 * User has the option to display Customer Manifest Information based on the search parameters Flight Number, Flight Suffix, Flight Date, Board Point.
 * 
...
@XmlRootElement(name = "CHK_CustomerManifestRQ")
public class CHKCustomerManifestRQ
