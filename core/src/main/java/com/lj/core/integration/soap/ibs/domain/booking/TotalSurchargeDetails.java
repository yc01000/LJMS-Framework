...
/**
 * <p>TotalSurchargeDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="TotalSurchargeDetails"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Surcharge" type="{http://www.ibsplc.com/iRes/simpleTypes/}Surcharge" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "TotalSurchargeDetails", propOrder = {
    "surcharge",
    "test"
})
public class TotalSurchargeDetails
