 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AuxDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}AuxType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RetrieveAUXRulesRS")
public class RetrieveAUXRulesRS
    implements Serializable
{

    private final static long serialVersionUID = -1L;
    @XmlElement(name = "AuxDetails")
    protected List<AuxType> auxDetails;
     ...
     * 
     */
    public List<AuxType> getAuxDetails() {
        if (auxDetails == null) {
            auxDetails = new ArrayList<AuxType>();
        }
