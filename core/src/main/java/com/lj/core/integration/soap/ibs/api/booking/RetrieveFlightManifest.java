...
import com.lj.core.integration.soap.ibs.domain.booking.RetrieveFlightManifestRQ;
import com.lj.core.integration.soap.ibs.domain.booking.RetrieveFlightManifestRS;

@Component("RetrieveFlightManifest")
public class RetrieveFlightManifest extends IbsSoapConnector<RetrieveFlightManifestRQ, RetrieveFlightManifestRS, IbsSoapProperty>{
	
	@Value("#{IbsBookingProperties['booking.flight.endpoint']}")
	private String endpoint;
	
	@Value("#{IbsBookingProperties['booking.flight.retrieveFlightManifest']}")
	private String action;
	
	@Resource(name="webServiceTemplate.booking")
	private WebServiceTemplate webServiceTemplate;

	public RetrieveFlightManifestRS request(RetrieveFlightManifestRQ req, IbsSoapProperty property){
		initiate(endpoint, action);
		RetrieveFlightManifestRS response = null;
		try{
			super.setWebServiceTemplate(webServiceTemplate);
			response = super.request(req, property);
		}catch(SoapFaultException sfe){			
			response = new RetrieveFlightManifestRS();
