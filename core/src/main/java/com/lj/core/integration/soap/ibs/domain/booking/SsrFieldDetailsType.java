...
/**
 * <p>SsrFieldDetailsType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="SsrFieldDetailsType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="SsrFieldName" type="{http://www.ibsplc.com/iRes/simpleTypes/}SsrFieldNameDetails_Type" minOccurs="0"/&gt;
...
@XmlType(name = "SsrFieldDetailsType", propOrder = {
    "ssrFieldName",
    "ssrFieldValue"
})
