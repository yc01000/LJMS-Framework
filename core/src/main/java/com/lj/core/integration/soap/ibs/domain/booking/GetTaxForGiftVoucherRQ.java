 ...
 *         &lt;element name="GCTaxCountry" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlRootElement(name = "GetTaxForGiftVoucherRQ")
public class GetTaxForGiftVoucherRQ
    implements Serializable
{
    ...
    @XmlElement(name = "GCTaxCountry", required = true)
    protected String gcTaxCountry;
     ...
     *     
     */
    public String getGCTaxCountry() {
        return gcTaxCountry;
    }

    /**
     * gcTaxCountry 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGCTaxCountry(String value) {
        this.gcTaxCountry = value;
    }
