 ...
 *         &lt;element name="BookerDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}BookerDetails"/>
 ...
 *         &lt;element name="IsCancelMode" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 ...
 *         &lt;element name="CanBypassASRValidation" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="TravelDocumentsChangeType" type="{http://www.ibsplc.com/iRes/simpleTypes/}TravelDocumentsChangeType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="DiscountCouponChangeDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}DiscountCouponChangeDetails" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    ...
    "canBypassASRValidation",
    "travelDocumentsChangeType",
    "tourCode",
    "isPnrUnpaid",
    "pnrOnHoldIndicator",
    "discountCouponChangeDetails",
    "externalRecordLocatorDetails",
    "isManualPriceRequired",
    "canOverrideMctViolation"
})
@XmlRootElement(name = "SaveReservationRQ")
public class SaveReservationRQ
    extends BaseBookingRQ
{
    ...
    @XmlElement(name = "BookerDetails", required = true)
    ...
    @XmlElement(name = "IsCancelMode")
    protected boolean isCancelMode;
    ...
    @XmlElement(name = "CanBypassASRValidation")
    protected Boolean canBypassASRValidation;
    @XmlElement(name = "TravelDocumentsChangeType")
    protected List<TravelDocumentsChangeType> travelDocumentsChangeType;
    @XmlElement(name = "TourCode")
    protected String tourCode;
    protected Boolean isPnrUnpaid;
    protected Boolean pnrOnHoldIndicator;
    @XmlElement(name = "DiscountCouponChangeDetails")
    protected List<DiscountCouponChangeDetails> discountCouponChangeDetails;
    ...
    /**
     * isCancelMode 속성의 값을 가져옵니다.
     * 
     */
    public boolean isIsCancelMode() {
        return isCancelMode;
    }

    /**
     * isCancelMode 속성의 값을 설정합니다.
     * 
     */
    public void setIsCancelMode(boolean value) {
        this.isCancelMode = value;
    }
    ...
    /**
     * canBypassASRValidation 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isCanBypassASRValidation() {
        return canBypassASRValidation;
    }

    /**
     * canBypassASRValidation 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setCanBypassASRValidation(Boolean value) {
        this.canBypassASRValidation = value;
    }

    /**
     * Gets the value of the travelDocumentsChangeType property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the travelDocumentsChangeType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTravelDocumentsChangeType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TravelDocumentsChangeType }
     * 
     * 
     */
    public List<TravelDocumentsChangeType> getTravelDocumentsChangeType() {
        if (travelDocumentsChangeType == null) {
            travelDocumentsChangeType = new ArrayList<TravelDocumentsChangeType>();
        }
        return this.travelDocumentsChangeType;
    }
    ...
    /**
     * Gets the value of the discountCouponChangeDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the discountCouponChangeDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDiscountCouponChangeDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DiscountCouponChangeDetails }
     * 
     * 
     */
    public List<DiscountCouponChangeDetails> getDiscountCouponChangeDetails() {
        if (discountCouponChangeDetails == null) {
            discountCouponChangeDetails = new ArrayList<DiscountCouponChangeDetails>();
        }
        return this.discountCouponChangeDetails;
    }
