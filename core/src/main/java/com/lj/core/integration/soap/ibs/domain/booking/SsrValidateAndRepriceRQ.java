 ...
 *         &lt;element name="SsrClientVODetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}SsrClientVODetails" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "SsrValidateAndRepriceRQ")
public class SsrValidateAndRepriceRQ {
    ...
    @XmlElement(name = "SsrClientVODetails", required = true)
    protected List<SsrClientVODetails> ssrClientVODetails;
    ...
    /**
     * Gets the value of the ssrClientVODetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ssrClientVODetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSsrClientVODetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SsrClientVODetails }
     * 
     * 
     */
    public List<SsrClientVODetails> getSsrClientVODetails() {
        if (ssrClientVODetails == null) {
            ssrClientVODetails = new ArrayList<SsrClientVODetails>();
        }
        return this.ssrClientVODetails;
    }
