 ...
 *         &lt;element name="NearBySearches" type="{http://www.ibsplc.com/iRes/simpleTypes/}NearBySearchType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "NearBySearchRQ")
public class NearBySearchRQ {

    @XmlElement(name = "AirlineCode", required = true)
    protected String airlineCode;
    @XmlElement(name = "NearBySearches", required = true)
    protected List<NearBySearchType> nearBySearches;
    ...
    /**
     * Gets the value of the nearBySearches property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nearBySearches property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNearBySearches().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NearBySearchType> getNearBySearches() {
        if (nearBySearches == null) {
            nearBySearches = new ArrayList<NearBySearchType>();
        }
        return this.nearBySearches;
    }
