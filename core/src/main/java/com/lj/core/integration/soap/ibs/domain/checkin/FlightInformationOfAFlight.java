...
/**
 * Flight Information of a flight.
 * 
 * <p>FlightInformationOfAFlight complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="FlightInformationOfAFlight"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="FltSegInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}FltSegInfo" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FlightInformationOfAFlight", propOrder = {
    "flightIdentifier",
    "journeyTime",
    "fltSegInfo"
})
public class FlightInformationOfAFlight
    implements Serializable
{
    ...
    @XmlElement(name = "FltSegInfo", required = true)
    protected List<FltSegInfo> fltSegInfo;
    ...
    /**
     * Gets the value of the fltSegInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fltSegInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFltSegInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FltSegInfo> getFltSegInfo() {
        if (fltSegInfo == null) {
            fltSegInfo = new ArrayList<FltSegInfo>();
        }
        return this.fltSegInfo;
    }
