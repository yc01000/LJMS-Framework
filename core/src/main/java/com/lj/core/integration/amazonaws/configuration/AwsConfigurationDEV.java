...
@Configuration
@MatcherProfile("dev")
public class AwsConfigurationDEV {
	/**
	...
	public PropertiesFactoryBean awsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/dev/aws-properties.xml"));
	...
	public PropertiesFactoryBean kmsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/dev/kms-properties.xml"));
