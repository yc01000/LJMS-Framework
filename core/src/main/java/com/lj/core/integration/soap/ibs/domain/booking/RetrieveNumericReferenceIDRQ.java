 ...
 *         &lt;element name="OrderIDGenerationInd" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "bookingChannel",
    "pnrNumber",
    "orderIDGenerationInd"
})
@XmlRootElement(name = "RetrieveNumericReferenceIDRQ")
public class RetrieveNumericReferenceIDRQ
    implements Serializable
{
    ...
    @XmlElement(name = "OrderIDGenerationInd")
    protected Boolean orderIDGenerationInd;
    ...
    /**
     * orderIDGenerationInd 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isOrderIDGenerationInd() {
        return orderIDGenerationInd;
    }

    /**
     * orderIDGenerationInd 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setOrderIDGenerationInd(Boolean value) {
        this.orderIDGenerationInd = value;
    }
