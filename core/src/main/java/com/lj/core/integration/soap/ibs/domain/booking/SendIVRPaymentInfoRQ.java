 ...
 *         &lt;element name="CardInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}CardInfoType"/&gt;
 *         &lt;element name="IvrSystemInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}IvrSystemInfoType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SendIVRPaymentInfoRQ")
public class SendIVRPaymentInfoRQ
    implements Serializable
{
    ...
    @XmlElement(name = "IvrSystemInfo", required = true)
    protected IvrSystemInfoType ivrSystemInfo;
    ...
    /**
     * ivrSystemInfo 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link IvrSystemInfoType }
     *     
     */
    public IvrSystemInfoType getIvrSystemInfo() {
        return ivrSystemInfo;
    }

    /**
     * ivrSystemInfo 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link IvrSystemInfoType }
     *     
     */
    public void setIvrSystemInfo(IvrSystemInfoType value) {
        this.ivrSystemInfo = value;
    }
