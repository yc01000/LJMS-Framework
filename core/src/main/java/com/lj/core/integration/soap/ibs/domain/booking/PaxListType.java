...
/**
 * <p>PaxListType complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Pax" type="{http://www.ibsplc.com/iRes/simpleTypes/}PaxObjType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
     ...
     * 
     */
    public List<PaxObjType> getPax() {
        if (pax == null) {
            pax = new ArrayList<PaxObjType>();
        }
        return this.pax;
    }
