...
/**
 * <p>PNRExtractPaxTicketDetailsType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="PNRExtractPaxTicketDetailsType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="InvoiceNumber" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PNRExtractPaxTicketDetailsType", propOrder = {
    "ticketNumber",
    "isConjunction",
...
public class PNRExtractPaxTicketDetailsType
    implements Serializable
{
    ...
    public List<String> getInvoiceNumber() {
        if (invoiceNumber == null) {
            invoiceNumber = new ArrayList<String>();
        }
