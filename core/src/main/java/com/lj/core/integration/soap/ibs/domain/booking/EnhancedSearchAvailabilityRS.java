 ...
 *         &lt;element name="SearchAvailabilityResults" type="{http://www.ibsplc.com/iRes/simpleTypes/}SearchAvailabilityResults" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "EnhancedSearchAvailabilityRS")
public class EnhancedSearchAvailabilityRS {

    @XmlElement(name = "ErrorType")
    protected ErrorType errorType;
    @XmlElement(name = "SearchAvailabilityResults")
    protected List<SearchAvailabilityResults> searchAvailabilityResults;
    ...
    /**
     * Gets the value of the searchAvailabilityResults property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the searchAvailabilityResults property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSearchAvailabilityResults().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SearchAvailabilityResults }
     * 
     * 
     */
    public List<SearchAvailabilityResults> getSearchAvailabilityResults() {
        if (searchAvailabilityResults == null) {
            searchAvailabilityResults = new ArrayList<SearchAvailabilityResults>();
        }
        return this.searchAvailabilityResults;
    }
