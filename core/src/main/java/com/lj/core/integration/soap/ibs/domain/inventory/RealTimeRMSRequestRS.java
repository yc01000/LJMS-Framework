 ...
 *         &lt;element name="FlightDepartureDate" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/&gt;
 *         &lt;element name="StatusCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="RMSCabindDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}CabinDetails" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RealTimeRMSRequestRS")
public class RealTimeRMSRequestRS
    implements Serializable
{
    ...
    @XmlElement(name = "FlightDepartureDate")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar flightDepartureDate;
    @XmlElement(name = "StatusCode")
    protected String statusCode;
    @XmlElement(name = "RMSCabindDetails")
    protected List<CabinDetails> rmsCabindDetails;
    ...
    /**
     * Gets the value of the rmsCabindDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rmsCabindDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRMSCabindDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CabinDetails> getRMSCabindDetails() {
        if (rmsCabindDetails == null) {
            rmsCabindDetails = new ArrayList<CabinDetails>();
        }
        return this.rmsCabindDetails;
    }
