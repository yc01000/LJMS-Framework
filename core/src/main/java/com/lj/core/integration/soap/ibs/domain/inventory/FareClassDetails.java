...
/**
 * <p>FareClassDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="FareClassDetails"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="SoldSeats" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlType(name = "FareClassDetails", propOrder = {
    "fareClassCode",
    "authorizedUnits",
    "soldSeats",
    "remainingSeats"
})
public class FareClassDetails
    implements Serializable
{
    ...
    /**
     * soldSeats 속성의 값을 설정합니다.
     * 
     */
    public void setSoldSeats(int value) {
