 ...
 *         &lt;element name="IsBaggageFeePending" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CHK_PrintBagTagRS")
public class CHKPrintBagTagRS
    implements Serializable
{
    ...
    @XmlElement(name = "IsBaggageFeePending")
    protected Boolean isBaggageFeePending;
    ...
    /**
     * isBaggageFeePending 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isIsBaggageFeePending() {
        return isBaggageFeePending;
    }

    /**
     * isBaggageFeePending 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setIsBaggageFeePending(Boolean value) {
        this.isBaggageFeePending = value;
    }
