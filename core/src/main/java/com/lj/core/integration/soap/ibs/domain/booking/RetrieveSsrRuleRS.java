 ...
 *         &lt;element name="SsrRules" type="{http://www.ibsplc.com/iRes/simpleTypes/}SsrRules" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RetrieveSsrRuleRS")
public class RetrieveSsrRuleRS
    implements Serializable
{
    ...
    protected List<SsrRules> ssrRules;
     ...
     * 
     */
    public List<SsrRules> getSsrRules() {
        if (ssrRules == null) {
            ssrRules = new ArrayList<SsrRules>();
        }
