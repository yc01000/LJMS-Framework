 ...
 *         &lt;element name="FFPDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}FFPDetailsInfo" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "CHK_UpdateFFPDetailsRQ")
public class CHKUpdateFFPDetailsRQ
    implements Serializable
{
    ...
    @XmlElement(name = "FFPDetails", required = true)
    protected List<FFPDetailsInfo> ffpDetails;
    ...
    /**
     * Gets the value of the ffpDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ffpDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFFPDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FFPDetailsInfo> getFFPDetails() {
        if (ffpDetails == null) {
            ffpDetails = new ArrayList<FFPDetailsInfo>();
        }
