 ...
 *         &lt;element name="AirportPairDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}AirportPairType"/&gt;
...
@XmlRootElement(name = "RetrieveFareQuoteForOAndDRQ")
public class RetrieveFareQuoteForOAndDRQ
    implements Serializable
{
    ...
    @XmlElement(name = "AirportPairDetails", required = true)
    protected AirportPairType airportPairDetails;
    ...
    /**
     * airportPairDetails 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public AirportPairType getAirportPairDetails() {
        return airportPairDetails;
    }

    /**
     * airportPairDetails 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link AirportPairType }
     *     
     */
    public void setAirportPairDetails(AirportPairType value) {
        this.airportPairDetails = value;
    }
