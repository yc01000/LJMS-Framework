 ...
 *         &lt;element name="NokDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}NokDetailsType" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "CHK_NokCollectionRQ")
public class CHKNokCollectionRQ
    implements Serializable
{
    ...
    @XmlElement(name = "NokDetails", required = true)
    protected List<NokDetailsType> nokDetails;
    ...
    /**
     * Gets the value of the nokDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nokDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNokDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NokDetailsType> getNokDetails() {
        if (nokDetails == null) {
            nokDetails = new ArrayList<NokDetailsType>();
        }
