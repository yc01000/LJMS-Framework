 ...
 *         &lt;element name="PaxBaggageInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}PaxBaggageType" maxOccurs="unbounded"/&gt;
 *         &lt;element name="ExcessFlowIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="IsActualWeightCaptured" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "paxBaggageInfo",
    "excessFlowIndicator",
    "isActualWeightCaptured"
})
@XmlRootElement(name = "CHK_AddGuestBaggageRQ")
public class CHKAddGuestBaggageRQ
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "PaxBaggageInfo", required = true)
    protected List<PaxBaggageType> paxBaggageInfo;
    @XmlElement(name = "ExcessFlowIndicator")
    protected Boolean excessFlowIndicator;
    @XmlElement(name = "IsActualWeightCaptured")
    protected Boolean isActualWeightCaptured;
    ...
    /**
     * Gets the value of the paxBaggageInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the paxBaggageInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPaxBaggageInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PaxBaggageType> getPaxBaggageInfo() {
        if (paxBaggageInfo == null) {
            paxBaggageInfo = new ArrayList<PaxBaggageType>();
        }
        return this.paxBaggageInfo;
    }
    ...
    /**
     * isActualWeightCaptured 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isIsActualWeightCaptured() {
        return isActualWeightCaptured;
    }

    /**
     * isActualWeightCaptured 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setIsActualWeightCaptured(Boolean value) {
        this.isActualWeightCaptured = value;
    }
