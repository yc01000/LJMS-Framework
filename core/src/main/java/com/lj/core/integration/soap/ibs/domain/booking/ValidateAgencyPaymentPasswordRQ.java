...
@XmlRootElement(name = "ValidateAgencyPaymentPasswordRQ")
public class ValidateAgencyPaymentPasswordRQ {
    ...
    @XmlElement(name = "CreditUsagePassword", required = true)
    ...
    /**
     * creditUsagePassword 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * creditUsagePassword 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
