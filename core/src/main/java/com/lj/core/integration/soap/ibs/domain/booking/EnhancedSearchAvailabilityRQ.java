 ...
 *         &lt;element name="JourneyData" type="{http://www.ibsplc.com/iRes/simpleTypes/}OandDDetails" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="TicketedDate" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
 *         &lt;element name="PnrCreationTime" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
...
@XmlRootElement(name = "EnhancedSearchAvailabilityRQ")
public class EnhancedSearchAvailabilityRQ {

    @XmlElement(name = "AirlineCode", required = true)
    protected String airlineCode;
    @XmlElement(name = "JourneyData")
    protected List<OandDDetails> journeyData;
    ...
    @XmlElement(name = "TicketedDate", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar ticketedDate;
    @XmlElement(name = "PnrCreationTime", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
     ...
     * This is why there is not a <CODE>set</CODE> method for the journeyData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getJourneyData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OandDDetails> getJourneyData() {
        if (journeyData == null) {
            journeyData = new ArrayList<OandDDetails>();
        }
