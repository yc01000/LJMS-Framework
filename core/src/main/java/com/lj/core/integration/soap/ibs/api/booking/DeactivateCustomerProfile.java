...
import com.lj.core.integration.soap.ibs.domain.booking.DeactivateCustomerProfileRQ;
import com.lj.core.integration.soap.ibs.domain.booking.DeactivateCustomerProfileRS;
import com.lj.core.integration.soap.ibs.domain.booking.ErrorType;

@Component("DeactivateCustomerProfile")
public class DeactivateCustomerProfile extends IbsSoapConnector<DeactivateCustomerProfileRQ, DeactivateCustomerProfileRS, IbsSoapProperty>{
	
	@Value("#{IbsBookingProperties['booking.customerProfile.endpoint']}")
	private String endpoint;
	
	@Value("#{IbsBookingProperties['booking.customerProfile.deactivateCustomerProfile']}")
	private String action;
	
	@Resource(name="webServiceTemplate.booking")
	private WebServiceTemplate webServiceTemplate;
	
	public DeactivateCustomerProfileRS request(DeactivateCustomerProfileRQ req, IbsSoapProperty property){
		initiate(endpoint, action);
		DeactivateCustomerProfileRS response = null;
		try{
			super.setWebServiceTemplate(webServiceTemplate);
			response = super.request(req, property);
		}catch(SoapFaultException sfe){			
			response = new DeactivateCustomerProfileRS();
