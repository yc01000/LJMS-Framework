 ...
 *         &lt;element name="PaymentInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}PaymentDetailsType"/&gt;
 ...
 *         &lt;element name="SegmentInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}SegmentInfo" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CHK_ProcessPaymentRQ")
public class CHKProcessPaymentRQ
    implements Serializable
{
    ...
    protected PaymentDetailsType paymentInfo;
     ...
     *     
     */
    public PaymentDetailsType getPaymentInfo() {
        return paymentInfo;
    }

    /**
     * paymentInfo 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link PaymentDetailsType }
     *     
     */
    public void setPaymentInfo(PaymentDetailsType value) {
