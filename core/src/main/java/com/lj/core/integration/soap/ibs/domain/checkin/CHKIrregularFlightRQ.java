 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IrregularCode" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="FlightIdentifier" type="{http://www.ibsplc.com/iRes/simpleTypes/}FlightIdentifierType"/&gt;
 *         &lt;element name="LegInfo" type="{http://www.ibsplc.com/iRes/simpleTypes/}LegInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CHK_IrregularFlightRQ")
public class CHKIrregularFlightRQ
    implements Serializable
{

    private final static long serialVersionUID = -1L;
    @XmlElement(name = "IrregularCode", required = true)
    protected String irregularCode;
    @XmlElement(name = "FlightIdentifier", required = true)
    protected FlightIdentifierType flightIdentifier;
    @XmlElement(name = "LegInfo")
    protected List<LegInfoType> legInfo;
    @XmlElement(name = "ChannelKey", required = true)
    protected ChannelKeyType channelKey;

    /**
     * irregularCode 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
     ...
     *     
     */
    public void setIrregularCode(String value) {
        this.irregularCode = value;
    }
     ...
     * 
     */
    public List<LegInfoType> getLegInfo() {
        if (legInfo == null) {
            legInfo = new ArrayList<LegInfoType>();
        }
        return this.legInfo;
    }
