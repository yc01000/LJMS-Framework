...
/**
 * <p>StopOverDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="StopOverDetails"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="ArrivalDate" type="{http://www.ibsplc.com/iRes/simpleTypes/}DateOnlyType"/&gt;
...
@XmlType(name = "StopOverDetails", propOrder = {
    "flightDesignator",
    "departureDate",
    "arrivalDate",
    "day",
    ...
    implements Serializable
{
    ...
    protected DateOnlyType arrivalDate;
    @XmlElement(name = "Day")
    protected int day;
     ...
     *     
     */
    public DateOnlyType getArrivalDate() {
        return arrivalDate;
    }
     ...
     *     
     */
    public void setArrivalDate(DateOnlyType value) {
