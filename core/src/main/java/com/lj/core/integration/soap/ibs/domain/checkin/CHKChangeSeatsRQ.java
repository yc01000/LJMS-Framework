 ...
 *         &lt;element name="SegmentSeat" type="{http://www.ibsplc.com/iRes/simpleTypes/}SegmentSeatType"/&gt;
...
@XmlRootElement(name = "CHK_ChangeSeatsRQ")
public class CHKChangeSeatsRQ
    implements Serializable
{
    ...
    @XmlElement(name = "SegmentSeat", required = true)
