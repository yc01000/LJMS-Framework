 ...
 *         &lt;element name="UpgradeCabinDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}UpgradeSegmentInfo" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "CHK_UpgradeCabinClassVolRQ")
public class CHKUpgradeCabinClassVolRQ
    implements Serializable
{
    ...
    @XmlElement(name = "UpgradeCabinDetails", required = true)
    protected List<UpgradeSegmentInfo> upgradeCabinDetails;
    ...
    /**
     * Gets the value of the upgradeCabinDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the upgradeCabinDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUpgradeCabinDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UpgradeSegmentInfo }
     * 
     * 
     */
    public List<UpgradeSegmentInfo> getUpgradeCabinDetails() {
        if (upgradeCabinDetails == null) {
            upgradeCabinDetails = new ArrayList<UpgradeSegmentInfo>();
        }
        return this.upgradeCabinDetails;
    }
