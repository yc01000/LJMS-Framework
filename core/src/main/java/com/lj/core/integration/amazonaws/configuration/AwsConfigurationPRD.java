...
@Configuration
@MatcherProfile("prd")
public class AwsConfigurationPRD {
	/**
	...
	public PropertiesFactoryBean awsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/prd/aws-properties.xml"));
	...
	public PropertiesFactoryBean kmsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/prd/kms-properties.xml"));
