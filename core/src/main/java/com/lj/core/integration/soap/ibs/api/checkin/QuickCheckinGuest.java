...
import com.lj.core.integration.soap.ibs.domain.checkin.CHKQuickCheckinGuestRQ;
import com.lj.core.integration.soap.ibs.domain.checkin.CHKQuickCheckinGuestRS;
import com.lj.core.integration.soap.ibs.domain.checkin.ErrorType;

@Component("QuickCheckinGuest")
public class QuickCheckinGuest extends IbsSoapConnector<CHKQuickCheckinGuestRQ, CHKQuickCheckinGuestRS, IbsSoapProperty>{
	
	@Value("#{IbsBookingProperties['checkin.checkin.endpoint']}")
	private String endpoint;
	
	@Value("#{IbsBookingProperties['checkin.checkin.quickCheckinGuest']}")
	...
	public CHKQuickCheckinGuestRS request(CHKQuickCheckinGuestRQ req, IbsSoapProperty property){
		initiate(endpoint, action);
		CHKQuickCheckinGuestRS response = null;
		try{
			super.setWebServiceTemplate(webServiceTemplate);
			response = super.request(req, property);
		}catch(SoapFaultException sfe){			
			response = new CHKQuickCheckinGuestRS();
