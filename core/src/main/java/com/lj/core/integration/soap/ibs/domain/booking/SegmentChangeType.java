...
/**
 * <p>SegmentChangeType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="SegmentChangeType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="PnrActionType" type="{http://www.ibsplc.com/iRes/simpleTypes/}PnrActionType"/&gt;
 *         &lt;element name="OldSegmentId" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "SegmentChangeType", propOrder = {
    "pnrActionType",
    "oldSegmentId",
    "flightSegmentDetails"
})
public class SegmentChangeType
    implements Serializable
{
    ...
    @XmlElement(name = "OldSegmentId", type = Long.class)
    protected List<Long> oldSegmentId;
     ...
     * 
     */
    public List<Long> getOldSegmentId() {
        if (oldSegmentId == null) {
            oldSegmentId = new ArrayList<Long>();
        }
