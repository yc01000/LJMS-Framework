 ...
 *         &lt;element name="GuestSeatDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}GuestSeatFeeInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CHK_AssignSeatsForMultipleGuestsRS")
public class CHKAssignSeatsForMultipleGuestsRS
    implements Serializable
{
    ...
    protected List<GuestSeatFeeInfo> guestSeatDetails;
     ...
     * 
     */
    public List<GuestSeatFeeInfo> getGuestSeatDetails() {
        if (guestSeatDetails == null) {
            guestSeatDetails = new ArrayList<GuestSeatFeeInfo>();
        }
