 ...
 *         &lt;element name="ProviderDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}ProviderDetails" minOccurs="0"/&gt;
 ...
 *         &lt;element name="CanBypassDupeCheck" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CreateCustomerProfileRQ")
public class CreateCustomerProfileRQ
    implements Serializable
{
    ...
    @XmlElement(name = "CanBypassDupeCheck")
    protected Boolean canBypassDupeCheck;
    ...
    /**
     * canBypassDupeCheck 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isCanBypassDupeCheck() {
        return canBypassDupeCheck;
    }

    /**
     * canBypassDupeCheck 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setCanBypassDupeCheck(Boolean value) {
        this.canBypassDupeCheck = value;
    }
