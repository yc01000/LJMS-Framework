 ...
 *         &lt;element name="DocumentDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}DocumentDetailsType" maxOccurs="unbounded"/&gt;
 ...
 *         &lt;element name="sendAPIS" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CHK_ApisCollectionRQ")
public class CHKApisCollectionRQ
    implements Serializable
{
     ...
     *     
     */
    public Boolean isSendAPIS() {
        return sendAPIS;
    }

    /**
     * sendAPIS 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setSendAPIS(Boolean value) {
        this.sendAPIS = value;
    }
