...
/**
 * The fee info for pax or baggage checkin,if exists.
 * 
 * <p>CheckinFeeInformation complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="CheckinFeeInformation"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CheckinFeeInformation", propOrder = {
    "guestName",
    "pnrNumber",
    "amount",
    "currency"
})
public class CheckinFeeInformation
