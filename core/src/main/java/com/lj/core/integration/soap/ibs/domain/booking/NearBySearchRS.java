 ...
 *         &lt;element name="AvailabilityResults" type="{http://www.ibsplc.com/iRes/simpleTypes/}SearchAvailabilityResults" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "NearBySearchRS")
public class NearBySearchRS {

    @XmlElement(name = "ErrorType")
    protected ErrorType errorType;
    @XmlElement(name = "AvailabilityResults")
    protected List<SearchAvailabilityResults> availabilityResults;
    ...
    /**
     * Gets the value of the availabilityResults property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the availabilityResults property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAvailabilityResults().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SearchAvailabilityResults> getAvailabilityResults() {
        if (availabilityResults == null) {
            availabilityResults = new ArrayList<SearchAvailabilityResults>();
        }
