...
@Configuration
@MatcherProfile("stg")
public class AwsConfigurationSTG {
	/**
	...
	public PropertiesFactoryBean awsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/stg/aws-properties.xml"));
	...
	public PropertiesFactoryBean kmsConfig() {
		...
		bean.setLocations(new ClassPathResource("property/stg/kms-properties.xml"));
