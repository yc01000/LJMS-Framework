...
/**
 * Base Checkin Request
 * 
 * <p>BaseCheckinRQ complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="BaseCheckinRQ"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BaseCheckinRQ", propOrder = {
    "airlineCode",
    "channelKey"
})
@XmlSeeAlso({
    CHKSendBoardingPassRQ.class,
    CHKReportStandbyGuestRQ.class,
    CHKAddGuestBaggageRQ.class,
    CHKPrintBagTagRQ.class,
    CHKSearchGuestRQ.class,
    CHKCheckinGuestRQ.class,
    CHKPrintBoardingPassRQ.class
})
public class BaseCheckinRQ
