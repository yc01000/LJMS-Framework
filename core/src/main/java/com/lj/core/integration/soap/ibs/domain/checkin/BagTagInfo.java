...
/**
 * Contains the bag tag information
 * 
 * <p>BagTagInfo complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="BagTagInfo"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="BagTagIssuer" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "BagTagInfo", propOrder = {
    "bagTagIssuer",
    "bagTagNumber"
})
@XmlSeeAlso({
    GuestBagInfoType.class
})
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "BagTagIssuer", required = true)
