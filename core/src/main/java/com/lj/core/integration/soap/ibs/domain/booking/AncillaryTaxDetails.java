...
/**
 * <p>AncillaryTaxDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="AncillaryTaxDetails"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="TaxAmount" use="required" type="{http://www.w3.org/2001/XMLSchema}double" /&gt;
...
@XmlType(name = "AncillaryTaxDetails")
public class AncillaryTaxDetails
