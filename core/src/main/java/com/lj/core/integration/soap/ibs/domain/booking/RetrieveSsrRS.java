 ...
 *         &lt;element name="SSRRuleText" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "RetrieveSsrRS")
public class RetrieveSsrRS {
    ...
    @XmlElement(name = "SSRRuleText", required = true)
