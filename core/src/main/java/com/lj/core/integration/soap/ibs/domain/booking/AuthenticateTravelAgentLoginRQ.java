 ...
 *         &lt;element name="AgentLoginPassword" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlRootElement(name = "AuthenticateTravelAgentLoginRQ")
public class AuthenticateTravelAgentLoginRQ
    implements Serializable
{
    ...
    @XmlElement(name = "AgentLoginPassword", required = true)
    protected String agentLoginPassword;
    ...
    /**
     * agentLoginPassword 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * agentLoginPassword 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAgentLoginPassword(String value) {
        this.agentLoginPassword = value;
    }
