 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PNRList" type="{http://www.ibsplc.com/iRes/simpleTypes/}PNRList" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CustomerBookedListRS")
public class CustomerBookedListRS
    implements Serializable
{

    private final static long serialVersionUID = -1L;
    @XmlElement(name = "PNRList")
    protected List<PNRList> pnrList;
    ...
    /**
     * Gets the value of the pnrList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pnrList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPNRList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PNRList> getPNRList() {
        if (pnrList == null) {
            pnrList = new ArrayList<PNRList>();
        }
        return this.pnrList;
    }
