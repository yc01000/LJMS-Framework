 ...
 *         &lt;element name="LogonDb" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "LogonDb", required = true)
    protected String logonDb;
     ...
     *     
     */
    public String getLogonDb() {
        return logonDb;
    }

    /**
     * logonDb 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setLogonDb(String value) {
        this.logonDb = value;
    }
