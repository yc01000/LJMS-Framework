 ...
 *         &lt;element name="RevDocDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}RevDocDetailsType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RetrieveRevDocDetailsRS")
public class RetrieveRevDocDetailsRS
    implements Serializable
{
    ...
    @XmlElement(name = "RevDocDetails")
    protected List<RevDocDetailsType> revDocDetails;
    ...
    /**
     * Gets the value of the revDocDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the revDocDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRevDocDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RevDocDetailsType }
     * 
     * 
     */
    public List<RevDocDetailsType> getRevDocDetails() {
        if (revDocDetails == null) {
            revDocDetails = new ArrayList<RevDocDetailsType>();
        }
        return this.revDocDetails;
    }
