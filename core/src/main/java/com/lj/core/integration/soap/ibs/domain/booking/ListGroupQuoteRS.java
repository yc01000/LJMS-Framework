 ...
 *         &lt;element name="ListGroupQuote" type="{http://www.ibsplc.com/iRes/simpleTypes/}ListGroupQuoteType" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "ListGroupQuoteRS")
public class ListGroupQuoteRS
    implements Serializable
{
    ...
    @XmlElement(name = "ListGroupQuote", required = true)
    protected List<ListGroupQuoteType> listGroupQuote;
    ...
    /**
     * Gets the value of the listGroupQuote property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listGroupQuote property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getListGroupQuote().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ListGroupQuoteType }
     * 
     * 
     */
    public List<ListGroupQuoteType> getListGroupQuote() {
        if (listGroupQuote == null) {
            listGroupQuote = new ArrayList<ListGroupQuoteType>();
        }
        return this.listGroupQuote;
    }
