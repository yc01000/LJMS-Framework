 ...
 *         &lt;element name="RMSCabinDetailsRequest" type="{http://www.ibsplc.com/iRes/simpleTypes/}CabinDetails" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "flightDepartureDate",
    "inventoryChannel",
    "rmsCabinDetailsRequest"
})
@XmlRootElement(name = "RealTimeRMSRequestRQ")
public class RealTimeRMSRequestRQ
    implements Serializable
{
    ...
    @XmlElement(name = "RMSCabinDetailsRequest")
    protected List<CabinDetails> rmsCabinDetailsRequest;
    ...
    /**
     * Gets the value of the rmsCabinDetailsRequest property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rmsCabinDetailsRequest property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRMSCabinDetailsRequest().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CabinDetails> getRMSCabinDetailsRequest() {
        if (rmsCabinDetailsRequest == null) {
            rmsCabinDetailsRequest = new ArrayList<CabinDetails>();
        }
        return this.rmsCabinDetailsRequest;
    }
