...
/**
 * User has the get the check-in Report based on the search parameters Flight Number, Flight Suffix, Flight Date, Board Point.
 * 
...
@XmlRootElement(name = "CHK_CheckinReportRQ")
public class CHKCheckinReportRQ
