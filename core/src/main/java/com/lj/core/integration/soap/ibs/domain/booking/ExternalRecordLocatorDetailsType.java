...
/**
 * <p>ExternalRecordLocatorDetailsType complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="ExternalRecordLocatorDetailsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ExternalRecordLocatorDetailsType", propOrder = {
    "airlineCode",
    "recordLocatorNumber"
})
public class ExternalRecordLocatorDetailsType
    implements Serializable
{
    ...
    /**
     * recordLocatorNumber 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * recordLocatorNumber 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
