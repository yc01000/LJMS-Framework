...
/**
 * <p>AdditionalCCDetails complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="AdditionalCCDetails"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="InstallmentPeriod" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
...
@XmlType(name = "AdditionalCCDetails", propOrder = {
    "registrationNumber",
    "authType",
    "installmentPeriod",
    "cardPassword",
...
public class AdditionalCCDetails
    implements Serializable
{
    ...
    protected Integer installmentPeriod;
     ...
     *     
     */
    public void setInstallmentPeriod(Integer value) {
