 ...
 *         &lt;element name="CheckinSegments" type="{http://www.ibsplc.com/iRes/simpleTypes/}CheckinSegmentsType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CHK_RetrieveAPISConfigurationRQ")
public class CHKRetrieveAPISConfigurationRQ
    implements Serializable
{
    ...
    @XmlElement(name = "CheckinSegments")
