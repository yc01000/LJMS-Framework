 ...
 *         &lt;element name="LinkExpiryDate" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlRootElement(name = "ActivateCustomerProfileLoginRQ")
public class ActivateCustomerProfileLoginRQ
    implements Serializable
{
    ...
    @XmlElement(name = "LinkExpiryDate", required = true)
