 ...
 *         &lt;element name="giftVoucherNumber" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "SendGCEmailRQ")
public class SendGCEmailRQ
    implements Serializable
{
    ...
    protected List<String> giftVoucherNumber;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the giftVoucherNumber property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGiftVoucherNumber().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getGiftVoucherNumber() {
        if (giftVoucherNumber == null) {
            giftVoucherNumber = new ArrayList<String>();
        }
        return this.giftVoucherNumber;
    }
