...
import com.lj.core.integration.soap.ibs.domain.booking.RetrieveAgencyCreditRQ;
import com.lj.core.integration.soap.ibs.domain.booking.RetrieveAgencyCreditRS;


@Component("RetrieveAgencyCredit")
public class RetrieveAgencyCredit extends IbsSoapConnector<RetrieveAgencyCreditRQ, RetrieveAgencyCreditRS, IbsSoapProperty>{

	@Value("#{IbsBookingProperties['booking.agency.endpoint']}")
	private String endpoint;

	@Value("#{IbsBookingProperties['booking.agency.retrieveAgencyCredit']}")
	...
	@Override
	public RetrieveAgencyCreditRS request(RetrieveAgencyCreditRQ req, IbsSoapProperty property){
		initiate(endpoint, action);
		RetrieveAgencyCreditRS response = null;
		try{
			super.setWebServiceTemplate(webServiceTemplate);
			response = super.request(req, property);
		}catch(SoapFaultException sfe){
			response = new RetrieveAgencyCreditRS();
