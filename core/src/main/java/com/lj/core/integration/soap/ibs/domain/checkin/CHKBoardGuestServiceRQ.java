 ...
 *         &lt;element name="BoardInputDetails" type="{http://www.ibsplc.com/iRes/simpleTypes/}BoardInputType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CHK_BoardGuestServiceRQ")
public class CHKBoardGuestServiceRQ
    implements Serializable
{
    ...
    @XmlElement(name = "BoardInputDetails", required = true)
    protected List<BoardInputType> boardInputDetails;
    ...
    /**
     * Gets the value of the boardInputDetails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the boardInputDetails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBoardInputDetails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BoardInputType> getBoardInputDetails() {
        if (boardInputDetails == null) {
            boardInputDetails = new ArrayList<BoardInputType>();
        }
        return this.boardInputDetails;
    }
