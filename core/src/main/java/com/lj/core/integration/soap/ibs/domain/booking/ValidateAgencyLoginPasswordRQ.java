...
@XmlRootElement(name = "ValidateAgencyLoginPasswordRQ")
public class ValidateAgencyLoginPasswordRQ {

    @XmlElement(name = "AgencyCode")
    protected String agencyCode;
    @XmlElement(name = "CorporateId")
    protected String corporateId;
    @XmlElement(name = "AgencyPassword", required = true)
