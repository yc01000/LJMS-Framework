  ...
  <EasyDataTable
    ...
    <template #header-name="header">
      <div class="filter-column">
        <img src="../eglass-filter.png" class="filter-icon" @click.stop="showNameFilter=!showNameFilter">
        {{ header.text }}
    ...
    <template #header-age="header">
      <div class="filter-column">
        <img src="../eglass-filter.png" class="filter-icon" @click.stop="showAgeFilter=!showAgeFilter">
        {{ header.text }}
    ...
    <template #header-lastAttended="header">
      <div class="filter-column">
        <img src="../eglass-filter.png" class="filter-icon" @click.stop="showFavouriteSportFilter=!showFavouriteSportFilter">
        {{ header.text }}
        <div class="filter-menu filter-sport-menu" v-if="showFavouriteSportFilter">
          <select
            class="lastAttended-selector"
